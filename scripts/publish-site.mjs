...
const dataBucket = output("data_bucket");
const siteBucket = output("site_bucket");
const distributionId = output("cloudfront_distribution_id");
const siteUrl = output("site_url");
